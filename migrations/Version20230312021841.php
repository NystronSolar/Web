...
final class Version20230312021841 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bill (id INT NOT NULL, client_id INT NOT NULL, price VARCHAR(10) NOT NULL, actual_reading_date DATE NOT NULL, next_reading_date DATE NOT NULL, previous_reading_date DATE DEFAULT NULL, generation_balance VARCHAR(255) NOT NULL, energy_consumed VARCHAR(255) NOT NULL, energy_excess VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
